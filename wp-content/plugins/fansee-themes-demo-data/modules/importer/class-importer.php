...
class Importer extends Base{
	...
	public function __construct(){
		...
		$this->menu_title = esc_html__( 'Fansee Themes Demo Importer', 'fansee-themes-demo-data' );
	...
	public function ajax_activate_plugins(){
	    ...
	    if ( !is_wp_error( $installed ) && $installed ) {
		    ...
		    <div id="response-success">
		    	<span class="redirect-url"><?php echo $url; ?></span>
		    </div>
		    <?php
		} else {
		?>
	...
	public function create_plugin_page() {
		...
		$args = apply_filters( 'pt-ocdi/plugin_page_setup', array(
			...
			'page_title'  => esc_html__( 'Fansee Themes Demo Importer', 'fansee-themes-demo-data' ),
		...
		if( $demos && isset( $demos[ 'demos' ] ) && is_array( $demos[ 'demos' ] ) ){
			...
			foreach( $demos[ 'demos' ] as $demo ){
				...
				$contents[] = array(
					...
					'preview_url'                => 'https://demo.fanseethemes.com/' . $demo[ "preview" ],
